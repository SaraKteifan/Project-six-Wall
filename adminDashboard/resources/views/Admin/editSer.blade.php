                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="AdminProfile"
                                aria-expanded="false">
                        ...
                        {{-- deleted li --}}
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="Admin-map-google"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="AdminBlank"
                                aria-expanded="false">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div>
                                <form action="/AdminEditService/{{$editSer->id}}" method="post"  enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                    <label>Service Name:</label><br>
                                    <input style="width: 20%; height:30px;" class="mb-3" type="text" name="service_name" value="{{$editSer->service_name}}" required><br>
